   ...
   */
                    ...
                    switch (diffs[pointer].operation) {
                        ...
                        case Operation.EQUAL:
                            ...
                            if (count_delete >= 1 && count_insert >= 1) {
                                ...
                                List<Diff> a = diff_main(text_delete, text_insert, false);
     ...
     */
        ...
        protected List<Diff> diff_map(string text1, string text2) {
            ...
            var v_map1 = new List<HashSet<long>>();
            var v_map2 = new List<HashSet<long>>();
     ...
     */
        ...
        public string diff_prettyHtml(List<Diff> diffs) {
            ...
            foreach (Diff aDiff in diffs) {
                ...
                switch (aDiff.operation) {
                    case Operation.INSERT:
                        html.Append("<ins title=\"i=")
                            .Append(i).Append("\">").Append(text).Append("</ins>");
                        break;
                    case Operation.DELETE:
                        html.Append("<del title=\"i=")
     ...
     */
        ...
        public List<Patch> patch_fromText(string textline) {
            ...
            var textList = new List<string>(
                textline.Split(new[] {"\n"}, StringSplitOptions.None));
            var text = new LinkedList<string>(textList);
            Patch patch;
            var patchHeader
                = new Regex("^@@ -(\\d+),?(\\d*) \\+(\\d+),?(\\d*) @@$");
            Match m;
